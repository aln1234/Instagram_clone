...
function Modal() {
    ...
    as={Fragment}
    enter="ease-out duration-300"
    enterFrom="opacity-0 translate-y-4 sm:translate-y-o sm:scale-95"
    enterTo="opacity-100 translate-y-0 sm:scale-100"
    leave="ease-in duration-200"
    leaveFrom="opacity-100 translate-y-0 sm:scale-100"
    leaveTo="opacity-0 translate-y-4 sm:translate-y-o sm:scale-95"
    >
                    ...
                    <div className="mt-5 sm:mt-6">
                        ...
                        >
                            ...
                            <div>
                                ...
                                <div className="mt-2">
                                    <input
                                    className="border-none focuse:ring-0 w-full text-center"
                                    type="text"
                                    //ref ={captionRef}
                        ...
                        py-2 bg-red-600 text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-red-2
